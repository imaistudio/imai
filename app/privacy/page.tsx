      ...
      <main className="dark:bg-black dark:text-white min-h-screen flex flex-col items-center px-4">
        <section className="flex flex-col items-center max-w-5xl w-full space-y-8 py-12">
          ...
          <ul className="list-disc text-left dark:text-gray-400 pl-6 max-w-3xl space-y-2">
            ...
            <li>
              <strong>Usage Data:</strong> Information your browser or device sends automatically whenever you visit our Services. This may include information such as your computer&apos;s Internet Protocol (IP) address, browser type, browser version, the pages of our Services that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers, and other diagnostic data.
            </li>
            <li>
              <strong>Prompts and Generated Content:</strong> We collect the text prompts you submit to our Services and the images generated by our AI based on those prompts (&quot;Generated Content&quot;). While you retain appropriate rights to your Generated Content as per our Terms & Conditions, we process this data to provide and improve the Services.
            </li>
            <li>
              <strong>Cookies and Tracking Technologies:</strong> We may use cookies, beacons, tags, and scripts to collect and track information and to improve and analyze our Service. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Services.
            </li>
          </ul>
          ...
          <ul className="list-disc text-left dark:text-gray-400 pl-6 max-w-3xl space-y-2">
            ...
            <li>Improve, personalize, and expand our Services, including analyzing usage patterns and training our AI models (using anonymized and aggregated data where appropriate).</li>
            <li>Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the Service, and for marketing and promotional purposes (where you have consented).</li>
