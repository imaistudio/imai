...
const FASHION_PROMPTS = [
  "Scene: A high-fashion garment slowly ascends from a dense, mirror-like pool of ultra-black liquid. The surface stretches and clings momentarily before releasing the fabric, creating mesmerizing ripples and micro-splashes. The background remains minimal and dark to isolate the subject. Lighting: Crisp, diffused overhead lighting highlights the contours and textures of the emerging garment, while soft underlighting creates a glowing outline along its silhouette. Caustic, wave-like reflections shimmer subtly across the liquid and the fabric. Camera: Begins with a static wide shot, then slowly ascends on the Y-axis following the emergence. Transitions to a smooth 360° orbital glide around the garment, with occasional slow-motion tilts focused on the fabric’s motion and details. Detail Shots: Tight, slow zoom-ins on the wet fabric as it reveals textures like silk, leather, or embroidery, catching the dynamic lighting. Motion: The liquid pulls away as if magnetically repelled, creating a clean, dry reveal — no splashing onto the garment. Mood: Luxurious, futuristic, and almost surreal — like a digital runway in a dreamlike, high-tech realm. Styling: Keep the product centered and untouched; maintain original proportions, colors, and styling. No distortions or alterations to the garment.",
];
