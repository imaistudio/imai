...
export async function POST(request: NextRequest) {
  try {
    ...
    const userMessage =
      ...
      "Create an elemental pattern design using the uploaded elements";
    ...
    console.log(
      `🎨 ELEMENTAL DESIGN: Processing ${inputImages.length} input images`,
    );
...
Generate a professional elemental pattern design that incorporates all the identified elements in a harmonious, repeating composition.`;
    ...
    console.log(
      "✅ ELEMENTAL DESIGN: Output uploaded to Firebase:",
      firebaseOutputUrl,
    );
