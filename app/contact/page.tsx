        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center text-center min-h-screen">
            ...
            <small className="lg:pt-4">
              Our dedicated team at Imai Support has received your message &
              will get back to you shortly. <br></br> We truly appreciate you
              reaching out and look forward to assisting you!
            </small>
          </div>
        ) : (
          <>
